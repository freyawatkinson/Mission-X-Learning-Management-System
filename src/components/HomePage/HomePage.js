      ...
      <div className="ContainerOne">
        <div className="TopSection">
          ...
          <div className="LearnMoreContainer">
            ...
            <div id="SignUp">
              <button>SIGNUP</button> {/* <FormModal signupButton="SIGN UP" /> */}
              <p>*Basic subscription includes the first 15 project free of charge.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="Section5">
        ...
        <div className="Section5content">
          ...
          <div className="EnquireNow">
            ...
            <button style={{backgroundColor:"#f91c85", color:"white", borderColor: "#f91c85"}}>SIGN UP</button> {/*Modal for signing Up here*/}
          </div>
        </div>
      </div> 
      <Footer />
